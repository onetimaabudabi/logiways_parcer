"""«Гарант Интермодал» — SOC Шанхай/Пусан → Терминал Врангель + станции (август 2026).

Файл: data/01.08.-31.08.-SOC-Шанхай-Пусан-Врангель-станции-SOC.pdf
...
_PATTERN = r"01\.08.*Врангель[- ]станции"
...
_RAIL_CONDITIONS = (
    "ЖД от Терминала Врангель до станции назначения; "
...
def parse(file_path: str | Path | None = None) -> list[TariffSegment]:
    """Парсит прайс Врангель + станции и возвращает список сегментов."""
    ...
    print(f"  [Гарант SOC Врангель+станции] сегментов: {len(results)} "
